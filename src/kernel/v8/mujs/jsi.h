...
#define JS_ARRAYLIMIT                                                          \
  (1 << 26) /* limit arrays to 64M entries (1G of flat array data) */
#endif
#ifndef JS_GCFACTOR
/*
...
/* Hint to ToPrimitive() */
enum { JS_HNONE, JS_HNUMBER, JS_HSTRING };
...
js_Property *jsV_getpropertyx(js_State *J, js_Object *obj, const char *name,
                              int *own);
...
js_Ast *jsP_parsefunction(js_State *J, const char *filename, const char *params,
                          const char *body);
