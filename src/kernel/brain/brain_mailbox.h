...
struct BrainMailbox {
    ...
    volatile uint64_t tica_audit_context; // Hardware Telemetry for AI grounding
    volatile uint64_t energy_balance_gwei; // Metabolic Telemetry
